...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.max-consecutive-wins","generation.max-mary-spins","generation.max-members-per-multiplier","generation.normal-count","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.symbol.1.mary-weight","generation.symbol.1.normal-weight","generation.symbol.10.mary-weight","generation.symbol.10.normal-weight","generation.symbol.11.mary-weight","generation.symbol.11.normal-weight","generation.symbol.12.mary-weight","generation.symbol.12.normal-weight","generation.symbol.13.mary-weight","generation.symbol.13.normal-weight","generation.symbol.2.mary-weight","generation.symbol.2.normal-weight","generation.symbol.3.mary-weight","generation.symbol.3.normal-weight","generation.symbol.4.mary-weight","generation.symbol.4.normal-weight","generation.symbol.5.mary-weight","generation.symbol.5.normal-weight","generation.symbol.6.mary-weight","generation.symbol.6.normal-weight","generation.symbol.7.mary-weight","generation.symbol.7.normal-weight","generation.symbol.8.mary-weight","generation.symbol.8.normal-weight","generation.symbol.9.mary-weight","generation.symbol.9.normal-weight","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username"));
