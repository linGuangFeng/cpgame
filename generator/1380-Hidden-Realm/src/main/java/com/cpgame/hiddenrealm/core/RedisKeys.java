...
public final class RedisKeys {
    ...
    public static boolean special(ResultUtil.Outcome outcome) { return outcome == ResultUtil.Outcome.SPECIAL; }
    public static String index(String game, ResultUtil.Outcome outcome) {
        return special(outcome) ? maryIndex(game) : normalIndex(game);
    }
    public static String list(String game, ResultUtil.Outcome outcome, int multiplier) {
        return special(outcome) ? maryList(game, multiplier) : normalList(game, multiplier);
    }
