...
set "SCRIPT_DIR=%~dp0"
set "LOADER_JAR=%SCRIPT_DIR%redis-loader.jar"
...
echo Starting Beach Fun Redis round generator...
echo Config: %LOADER_CONFIG%
echo Redis must already be listening at redis.host:redis.port in generator.properties
echo Default is 192.168.10.3:6379 DB15. Connection refused means Redis is not running.
echo.
