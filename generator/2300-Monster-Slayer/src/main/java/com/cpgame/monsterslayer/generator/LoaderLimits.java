...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        for(String key:p.stringPropertyNames()) if(key.endsWith(".mary-weight") || key.equals("generation.special-trigger-weight-multiplier")) throw new IllegalArgumentException("Unsupported natural feature configuration: "+key);
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.buy-count-per-mode","generation.loss-count","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.max-centi-multiplier","generation.max-consecutive-wins","generation.max-mary-spins","generation.max-members-per-multiplier","generation.normal-max-total-multiplier","generation.normal-max-total-win-multiplier","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.normal-pool-max-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-total-multiplier","generation.special-max-total-win-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.special-pool-max-win-multiplier","generation.special-trigger-weight-multiplier","generation.symbol.1.mary-weight","generation.symbol.1.normal-weight","generation.symbol.10.mary-weight","generation.symbol.10.normal-weight","generation.symbol.100.mary-weight","generation.symbol.100.normal-weight","generation.symbol.2.mary-weight","generation.symbol.2.normal-weight","generation.symbol.3.mary-weight","generation.symbol.3.normal-weight","generation.symbol.4.mary-weight","generation.symbol.4.normal-weight","generation.symbol.5.mary-weight","generation.symbol.5.normal-weight","generation.symbol.6.mary-weight","generation.symbol.6.normal-weight","generation.symbol.7.mary-weight","generation.symbol.7.normal-weight","generation.symbol.8.mary-weight","generation.symbol.8.normal-weight","generation.symbol.9.mary-weight","generation.symbol.9.normal-weight","generation.win-count","range.normal-max","range.normal-min","range.special-max","range.special-min","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username","retention.special-per-multiplier"));
