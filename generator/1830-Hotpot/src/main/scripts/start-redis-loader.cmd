...
set "SCRIPT_DIR=%~dp0"
set "LOADER_JAR=%SCRIPT_DIR%hotpot-redis-loader.jar"
...
echo Starting Hotpot 1830 Redis round generator...
echo Config: %LOADER_CONFIG%
echo Redis must already be listening at redis.host:redis.port in generator.properties
echo Default Demo cache is 192.168.10.3:6379 database 15. Connection refused is a network/config issue, not a rule bug.
echo.
