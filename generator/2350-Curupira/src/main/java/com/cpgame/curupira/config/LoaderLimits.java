...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.loss.construction-attempts","generation.loss.fallback-samples","generation.loss.minimum-first-success-rate","generation.loss.validation-samples","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.max-consecutive-wins","generation.max-members-per-multiplier","generation.max-special-steps","generation.normal-count","generation.normal-max-total-multiplier","generation.normal-max-total-win-multiplier","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.normal-pool-max-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-total-multiplier","generation.special-max-total-win-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.special-pool-max-win-multiplier","generation.symbol.1.normal-weight","generation.symbol.11.normal-weight","generation.symbol.12.normal-weight","generation.symbol.13.normal-weight","generation.symbol.14.normal-weight","generation.symbol.2.normal-weight","generation.symbol.21.normal-weight","generation.symbol.3.normal-weight","generation.symbol.31.normal-weight","generation.symbol.4.normal-weight","range.normal-max","range.normal-min","range.special-max","range.special-min","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username","retention.special-per-multiplier"));
