...
public final class FreedomDayBoard {
    ...
    public FreedomDayBoard(int[] prop, int[] trl, List<List<Integer>> grids,
        ...
        FreedomDayGridRules.validate(this);
    }
    ...
    public List<Position> positionsOnReel(int reel) {
        ...
        for (int row = 0; row < ROW_COUNT; row++) {
            ...
            List<Integer> group = FreedomDayGridRules.groupAt(grids, index);
