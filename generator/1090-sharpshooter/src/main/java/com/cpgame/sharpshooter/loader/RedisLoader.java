...
public final class RedisLoader {
    public static void main(String[] args)throws Exception{
        ...
        String host=req(p,"redis.host"),game=req(p,"redis.game-id");int port=num(p,"redis.port",1,65535),db=num(p,"redis.database",0,15),loss=num(p,"generation.loss-count",0,1000000),win=num(p,"generation.win-count",0,1000000),special=num(p,"generation.special-count",0,1000000),cap=num(p,"generation.max-members-per-multiplier",1,1000000);
