...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        for(String key:p.stringPropertyNames()) if(key.startsWith("generation.symbol.initial.") || key.startsWith("generation.symbol.respin-redeal.")) throw new IllegalArgumentException("Unsupported configuration for fixed joint model: "+key);
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.max-consecutive-wins","generation.max-members-per-multiplier","generation.normal-count","generation.normal-max-total-multiplier","generation.normal-max-total-win-multiplier","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.normal-pool-max-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-total-multiplier","generation.special-max-total-win-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.special-pool-max-win-multiplier","generation.symbol.initial.blank","generation.symbol.initial.five","generation.symbol.initial.one","generation.symbol.initial.ten","generation.symbol.initial.zero","generation.symbol.respin-redeal.five","generation.symbol.respin-redeal.one","generation.symbol.respin-redeal.ten","generation.symbol.respin-redeal.zero","range.normal-max","range.normal-min","range.special-max","range.special-min","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username","retention.special-per-multiplier","weights.initial.none","weights.initial.respin","weights.initial.x2","weights.initial.x5","weights.mode","weights.respin-redeal"));
