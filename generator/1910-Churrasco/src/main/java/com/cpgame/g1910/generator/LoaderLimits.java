...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.free-symbol.1.weight","generation.free-symbol.10.weight","generation.free-symbol.11.weight","generation.free-symbol.12.weight","generation.free-symbol.13.weight","generation.free-symbol.2.weight","generation.free-symbol.3.weight","generation.free-symbol.4.weight","generation.free-symbol.5.weight","generation.free-symbol.6.weight","generation.free-symbol.7.weight","generation.free-symbol.8.weight","generation.free-symbol.9.weight","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.max-consecutive-wins","generation.max-members-per-multiplier","generation.max-win-units","generation.normal-count","generation.normal-max-total-multiplier","generation.normal-max-total-win-multiplier","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.normal-pool-max-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-total-multiplier","generation.special-max-total-win-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.special-pool-max-win-multiplier","generation.symbol.1.weight","generation.symbol.10.weight","generation.symbol.11.weight","generation.symbol.12.weight","generation.symbol.13.weight","generation.symbol.2.weight","generation.symbol.3.weight","generation.symbol.4.weight","generation.symbol.5.weight","generation.symbol.6.weight","generation.symbol.7.weight","generation.symbol.8.weight","generation.symbol.9.weight","range.normal-max","range.normal-min","range.special-max","range.special-min","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username","retention.special-per-multiplier"));
