...
public final class LoaderLimits {
    ...
    public static void checkKeys(Properties p) {
        java.util.Set<String> allowed=new java.util.HashSet<String>(java.util.Arrays.asList("generation.batch-size","generation.mary-max-win-multiplier","generation.mary-min-win-multiplier","generation.material.multiplier.10","generation.material.multiplier.2","generation.material.multiplier.3","generation.material.multiplier.5","generation.max-consecutive-wins","generation.max-members-per-multiplier","generation.mode.MULTIPLIER_STICKY.max-spins","generation.mode.MULTIPLIER_STICKY.weight","generation.mode.RESPIN_UNTIL_WIN.weight","generation.normal-count","generation.normal-max-total-multiplier","generation.normal-max-total-win-multiplier","generation.normal-max-win-multiplier","generation.normal-min-win-multiplier","generation.normal-pool-max-win-multiplier","generation.special-count","generation.special-max-members-per-multiplier","generation.special-max-total-multiplier","generation.special-max-total-win-multiplier","generation.special-max-win-multiplier","generation.special-min-win-multiplier","generation.special-pool-max-win-multiplier","generation.symbol.initial.10","generation.symbol.initial.2","generation.symbol.initial.20","generation.symbol.initial.3","generation.symbol.initial.5","generation.symbol.initial.50","generation.symbol.respin-reel.10","generation.symbol.respin-reel.2","generation.symbol.respin-reel.20","generation.symbol.respin-reel.3","generation.symbol.respin-reel.5","generation.symbol.respin-reel.50","range.normal-max","range.normal-min","range.special-max","range.special-min","redis.connect-timeout-ms","redis.database","redis.game-id","redis.host","redis.password","redis.port","redis.socket-timeout-ms","redis.ssl","redis.username","retention.special-per-multiplier"));
