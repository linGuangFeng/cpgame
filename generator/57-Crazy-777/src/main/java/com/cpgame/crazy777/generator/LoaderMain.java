...
public final class LoaderMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("Crazy 777 Redis Loader 完成：未中奖=%d，普通中奖=%d，免费=%d，事务批次=%d，候选=%d%n",
    ...
    private static Path findConfig(String[] args) {
        ...
        throw new IllegalArgumentException("用法：java -jar crazy777-loader.jar generator.properties");
    }
}
